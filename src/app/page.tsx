  ...
  return (
    <main className="bg-linear-to-br from-blue-50 to-green-50 min-h-[80vh] flex flex-col items-center justify-center py-24 px-4">
      <div className="max-w-2xl text-center">
        <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 mb-6 tracking-tight">Discover Modern </h1>
        <h2 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-6 tracking-tight">E-commerce</h2>
